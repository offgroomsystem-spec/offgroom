...
const MODELOS: { value: ModeloComissao; label: string; desc: string }[] = [
  { value: "groomer", label: "Comissão por Groomer", desc: "Percentual individual por groomer" },
  { value: "faturamento", label: "Comissão por Faturamento", desc: "Percentual único sobre o faturamento" },
