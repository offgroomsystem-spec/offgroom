...
      <CardHeader className="p-2 pb-1 px-0 py-0">
        <CardTitle className="flex items-center gap-2 text-base mx-0 px-0 my-0">
...
        {!valor && !textoDestaque && lista && lista.length > 0 && <ul className="list-disc list-inside space-y-1 text-sm">
            {lista.slice(0, 5).filter(item => item !== undefined && item !== null).map((item, idx) => <li key={idx}>
